...
<h3 align="center">🚀 DevOps Engineer | Kubernetes | Terraform | CI/CD | Docker | Azure | AWS | Cloud Platforms</h3>
...
A **production-style DevOps & GitOps platform implementation on Kubernetes (AKS)** using **cloud-agnostic DevOps practices with Terraform, Jenkins, and Argo CD**, re-architecting an existing application into a cloud-native delivery model.
...
- Integrated **Prometheus + Grafana observability stack**
...
A full-stack optical e-commerce platform deployed on Azure PaaS services before Kubernetes re-architecture.

- ASP.NET Core Web API + Next.js  
...
⭐ Thanks for visiting!  
I’m open to opportunities and discussions around **DevOps, Cloud Engineering, Kubernetes, and Platform Engineering**.
